...
public class AuthorCitationNetworkView extends GraphBasedView implements View, RefDirectionView, ActionListener {
	...
	public AuthorCitationNetworkView(DataInterface dataInterface, Graph graph, Set<IdRecord> rootIds) {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == cboRefDirection){
			graph = ViewBuilder.authorCitationNetworkGraph(dataInterface, (RefDirection) cboRefDirection.getSelectedItem(), getRootRecords(), getSelectedDepth(), null);
		}	
	}
	
	@Override
	protected void onDepthChanged(DataInterface dataInterface, boolean newGraphNeeded) {
		graph = ViewBuilder.authorCitationNetworkGraph(dataInterface, (RefDirection) cboRefDirection.getSelectedItem(), getRootRecords(), getSelectedDepth(), newGraphNeeded ? null : graph);
	}
	...
	public ViewType getViewType() {
		return ViewType.AUTHOR_CITATION_NETWORK;
	}
